...
ПРЕДУПРЕЖДЕНИЕ! Следующая команда удалит все данные в зашифрованном разделе. Вы потеряете всю свою информацию! Поэтому убедитесь, что вы сделали резервную копию своих данных на внешнем источнике, таком как NAS или жесткий диск, прежде чем вводить любую из следующих команд.

...
sudo pacman -S deadbeef radiotray smplayer smplayer-skins smplayer-themes smtube spotify vlc-tunein-radio easytag --noconfirm

echo 'Установка Офиса (LibreOffice still)'
sudo pacman -S libreoffice libreoffice-still libreoffice-still-ru --noconfirm
#sudo pacman -S libreoffice libreoffice-fresh-ru --noconfirm

echo 'Установка программ'
sudo pacman -S wget cmake git curl galculator-gtk2 flashplugin pepper-flash pidgin pidgin-extprefs pidgin-hotkeys firefox ufw qt4 f2fs-tools dosfstools ntfs-3g alsa-lib alsa-utils file-roller p7zip unrar gvfs aspell-ru pulseaudio --noconfirm
...
if [[ $prog_set == 1 ]]; then
  sudo pacman -S obs-studio veracrypt freemind filezilla cherrytree gimp libreoffice libreoffice-fresh-ru kdenlive doublecmd-gtk2 audacity screenfetch vlc qbittorrent gnome-calculator --noconfirm

...
echo "#### продолжением скриптов (archmy1,archmy2 и arcmy3) из серии      ####"
echo "#### 'arch_2020'. Для установки системы Arch'a' на PC (LegasyBIOS)  ####"
echo "#### с DE - рабочего стола Xfce.                                    ####"
echo "#### В сценарии (скрипта) archmy4 прописана установка необходимого  ####"                                         
echo "#### софта (пакетов) и запуск необходимых служб.                    ####"       

...
echo " Сначала взглянем на UUID идентификатор(ы) нашего устройства, запомним, запишем или сфоткаем его, и потом внесём (порядок в хаос) несколько правок /etc/default/grub "

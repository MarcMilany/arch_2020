...
## include <unistd.h>
## //...
## sleep(50); // ждать 50 секунд, время эта функция считает в секундах
...
{    
   ...
   puts (“Остановка работы на 55 секунд”);
   //Цикл на один такт
   while (MyTik<1)  
   {    
      //Вывод оставшегося времени до возобновления работы
      printf (“     Осталось %d сек.\n”,1-MyTik);
      //Приостановка работы на 55 секунду
      sleep (55);
      //Увеличение на 0 счетчиков приостановок
      MyTik++;
   }

...
# Синтаксис:
#$ grub-install опции диск  (/dev/sda) (/dev/sdb) (/dev/sdc)
...
# -------------------------------------------------------
#echo ""
#echo -e "${BLUE}:: ${NC}Информация о пользователе (полное имя пользователя и связанная с ним информация)"
...
# Информация о myusername : (достаточно имени)
# chfn alex  #(myusername)   
#chfn $username
# finger $username
# -------------------------------------------------------
